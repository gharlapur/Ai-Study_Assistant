...
We made a system that can read a document
...
**What AI part we used**

We used something called Generative AI, which means:

The computer can understand text
And generate answers like a human

But we made it smarter by not letting it guess randomly.
...
We didn’t build everything from scratch — We used some tools:
...
These tools helped us to turn our idea into a working project.
...
So we wanted to create something that:
...
While building this, We understood:
...
In short - We made a study helper that reads your notes and answers your questions like a smart friend.
